...
public class IFELootingAddonItem extends IFEAddonItem {
    public IFELootingAddonItem(int tier) {
        super(IFEAddonType.LOOTING, tier);
    }

    @Override
    public void addTooltipDetails(@Nullable Key key, @NotNull ItemStack stack, @NotNull List<Component> tooltip, boolean advanced) {
        TooltipHelper.addTooltip(tooltip,"looting_addon_item_0", ChatFormatting.GRAY);
        TooltipHelper.addTooltip(tooltip,"looting_addon_item_1",ChatFormatting.GREEN,new Object[]{getTier() + 1});
    }
