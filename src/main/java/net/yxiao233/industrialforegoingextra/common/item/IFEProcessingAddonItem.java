...
public class IFEProcessingAddonItem extends IFEAddonItem {
    public IFEProcessingAddonItem(int tier) {
        super(IFEAddonType.PROCESSING, tier);
    }
    ...
    public void addTooltipDetails(@Nullable BasicItem.Key key, @NotNull ItemStack stack, List<Component> tooltip, boolean advanced) {
        ...
        tooltip.add(Component.literal(var10001 + Component.translatable("text.industrialforegoing.tooltip.processing").getString() + "x" + (double) (this.getTier() + 1)));
    }
