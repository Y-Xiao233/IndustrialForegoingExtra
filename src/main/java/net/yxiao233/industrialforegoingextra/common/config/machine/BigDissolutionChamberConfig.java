...
public class BigDissolutionChamberConfig {
    ...
    @ConfigVal(comment = "Max Stored Power [FE] - Default: [100000 FE]")
    public static int maxStoredPower = 100000;
    @ConfigVal(comment = "Max Amount of Stored Fluid [Input] - Default: [80000mB]")
    public static int maxInputTankSize = 80000;
    @ConfigVal(comment = "Max Amount of Stored Fluid [Output] - Default: [80000mB]")
    public static int maxOutputTankSize = 80000;
