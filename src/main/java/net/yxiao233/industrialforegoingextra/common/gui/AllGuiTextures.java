package net.yxiao233.industrialforegoingextra.common.gui;
...
public enum AllGuiTextures implements ScreenElement {
    ...
    private AllGuiTextures(String location, int startX, int startY, int width, int height) {
        this.location = ResourceLocation.fromNamespaceAndPath(IndustrialForegoingExtra.MODID, "textures/gui/" + location + ".png");
        this.width = width;
        this.height = height;
        this.startX = startX;
        this.startY = startY;
    ...
    private AllGuiTextures(int startX, int startY, int width, int height) {
        this.location = ResourceLocation.fromNamespaceAndPath(IndustrialForegoingExtra.MODID, "textures/gui/widgets.png");
        this.width = width;
        this.height = height;
        this.startX = startX;
        this.startY = startY;
