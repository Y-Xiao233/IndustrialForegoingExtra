package net.yxiao233.industrialforegoingextra.compact.jade.provider;
...
import net.yxiao233.industrialforegoingextra.compact.jade.IFEJadeIds;
...
public class MachineTileProvider implements IBlockComponentProvider {
    ...
    public ResourceLocation getUid() {
        return IFEJadeIds.MACHINE_TILE;
    }
}
